...
import iamutkarshtiwari.github.io.ananas.editimage.fragment.crop.InitialCropFragment;
...
public class EditImageActivity extends BaseActivity implements OnLoadingDialogListener {
    ...
    public static final int MODE_INITIAL_CROP = 10;
    ...
    public InitialCropFragment initialCropFragment;
    ...
    public static void start(Fragment activity, Intent intent, int requestCode) {
        if (TextUtils.isEmpty(intent.getStringExtra(ImageEditorIntentBuilder.SOURCE_PATH))) {
            Toast.makeText(activity.getContext(), R.string.iamutkarshtiwari_github_io_ananas_not_selected, Toast.LENGTH_SHORT).show();
            return;
        }
        activity.startActivityForResult(intent, requestCode);
    }
    ...
    private void initView() {
        ...
        initialCropFragment = InitialCropFragment.newInstance();
    ...
    public void setMainBitmap(Bitmap newBit, boolean needPushUndoStack) {
        if (newBit == null)
            return;
    ...
    protected void onSaveTaskDone() {
        ...
        if (numberOfOperations > 0) {
            ...
            returnIntent.putExtra(ImageEditorIntentBuilder.SOURCE_PATH, sourceFilePath);
            returnIntent.putExtra(ImageEditorIntentBuilder.OUTPUT_PATH, sourceFilePath);
        }
    ...
    protected void onSaveTaskDone(boolean imageEdited) {
        Intent returnIntent = new Intent();

        returnIntent.putExtra(ImageEditorIntentBuilder.SOURCE_PATH, sourceFilePath);
        returnIntent.putExtra(ImageEditorIntentBuilder.OUTPUT_PATH, outputFilePath);
        returnIntent.putExtra(IS_IMAGE_EDITED, imageEdited);
    ...
    private final class BottomGalleryAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int index) {
            switch (index) {
                ...
                case InitialCropFragment.INDEX:
                    return initialCropFragment;
            }
